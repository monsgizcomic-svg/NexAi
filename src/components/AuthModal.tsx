          ...
          {activeTab === "google" && (
            <div className="flex flex-col gap-5 text-center">
              <div className="flex flex-col items-center gap-2 py-2">
                ...
                <h4 className="text-sm font-semibold text-[#EDEBF2]">Autentikasi dengan Akun Google</h4>
                <p className="text-xs text-[#8D8A99] max-w-xs leading-relaxed">
                  Gunakan akun Google Anda untuk masuk dengan cepat tanpa perlu membuat kata sandi baru.
                </p>
              </div>
              ...
              <button
                ...
                disabled={loading}
                className="w-full py-3 px-4 bg-white hover:bg-neutral-100 text-neutral-900 font-semibold text-xs rounded-xl flex items-center justify-center gap-2.5 transition-all cursor-pointer active:scale-98 disabled:opacity-50 shadow-md"
              >
                {loading ? (
